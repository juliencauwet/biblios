package openclassrooms.bibliobatch.config;

import openclassrooms.biblioback.ws.test.Borrowing;
import openclassrooms.biblioback.ws.test.BorrowingGetExpiredRequest;
import openclassrooms.biblioback.ws.test.TestPort;
import openclassrooms.biblioback.ws.test.TestPortService;
import openclassrooms.bibliobatch.batch.Processor;
import openclassrooms.bibliobatch.batch.SimpleMailItemWriter;
